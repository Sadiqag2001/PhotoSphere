...
//         <div className="w-[50%] py-25 px-10 flex flex-col justify-center text-white">
//           <h3 className="text-2xl font-bold pt-10">Create an Account</h3>
...
//               <input
//                 className="w-1/2 h-[48px] px-3 text-white text-sm placeholder:text-white/40 bg-white/5 rounded-sm"
...
const Register = () => {
  ...
  return (
    <div className="w-full h-auto bg-[#010f1b] pt-20 flex items-center justify-center">
      <div className="w-[90%] h-[90%] flex flex-col md:flex-row rounded-xl p-4 bg-[#2c2638]">
