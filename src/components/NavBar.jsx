  ...
  return (
    <div className='flex flex-row justify-between p-4'>
        <div className='flex flex-row justify-between items-center gap-8'>
            <h1 className='text-4xl text-gray-900'>PhotoSphere</h1>
        </div>
        <div className='relative w-full sm:w-auto '> 
            <input type="text" placeholder='What are you looking for? ' className='lg:pl-5 lg:pr-40 sm:pl-3 sm:pr-10 md:pl-5 md:pr-12 py-3 rounded-3xl border border-gray-300 focus:outline-none focus:ring-2 focus:ring-gray-300' />
